...
app.controller("UpdateSpeciesController", ["$scope", "$http", "$state", "speciesApi", function($scope, $http, $state, speciesApi) {
    ...
    // Danh sách 34 tỉnh mới
    $scope.vnProvinces34 = [
        { id: "VN-44, VN-47", text: "An Giang" },
        { id: "VN-54, VN-56", text: "Bắc Ninh" },
        { id: "VN-04", text: "Cao Bằng" },
        { id: "VN-55, VN-59", text: "Cà Mau" },
        { id: "VN-31, VN-30", text: "Gia Lai" },
        { id: "VN-HN", text: "Hà Nội" },
        { id: "VN-23", text: "Hà Tĩnh" },
        { id: "VN-66, VN-20", text: "Hưng Yên" },
        { id: "VN-61, VN-HP", text: "Hải Phòng" },
        { id: "VN-43, VN-57, VN-SG", text: "Hồ Chí Minh" },
        { id: "VN-34, VN-36", text: "Khánh Hòa" },
        { id: "VN-01", text: "Lai Châu" },
        { id: "VN-02, VN-06", text: "Lào Cai" },
        { id: "VN-40, VN-35, VN-72", text: "Lâm Đồng" },
        { id: "VN-09", text: "Lạng Sơn" },
        { id: "VN-22", text: "Nghệ An" },
        { id: "VN-63, VN-67, VN-18", text: "Ninh Bình" },
        { id: "VN-14, VN-68, VN-70", text: "Phú Thọ" },
        { id: "VN-28, VN-29", text: "Quảng Ngãi" },
        { id: "VN-13", text: "Quảng Ninh" },
        { id: "VN-24, VN-25", text: "Quảng Trị" },
        { id: "VN-05", text: "Sơn La" },
        { id: "VN-21", text: "Thanh Hóa" },
        { id: "VN-CT, VN-73, VN-52", text: "Thành phố Cần Thơ" },
        { id: "VN-53, VN-69", text: "Thái Nguyên" },
        { id: "VN-26", text: "Thừa Thiên-Huế" },
        { id: "VN-03, VN-07", text: "Tuyên Quang" },
        { id: "VN-41, VN-37", text: "Tây Ninh" },
        { id: "VN-50, VN-51, VN-49", text: "Vĩnh Long" },
        { id: "VN-71", text: "Điện Biên" },
        { id: "VN-27, VN-DN", text: "Đà Nẵng" },
        { id: "VN-32, VN-33", text: "Đắk Lắk" },
        { id: "VN-58, VN-39", text: "Đồng Nai" },
        { id: "VN-46, VN-45", text: "Đồng Tháp" }
    ];

    // Mapping tên/id cũ sang tên mới (tương tự backend, chỉ lấy tên mới)
    $scope.provinceOldToNew = {
        "An Giang": "An Giang", "VN-44": "An Giang", "VN-47": "An Giang", "Kiên Giang": "An Giang",
        "Bắc Ninh": "Bắc Ninh", "VN-54": "Bắc Ninh", "VN-56": "Bắc Ninh", "Bắc Giang": "Bắc Ninh",
        "Cao Bằng": "Cao Bằng", "VN-04": "Cao Bằng",
        "Cà Mau": "Cà Mau", "VN-55": "Cà Mau", "VN-59": "Cà Mau", "Bạc Liêu": "Cà Mau",
        "Gia Lai": "Gia Lai", "VN-31": "Gia Lai", "VN-30": "Gia Lai", "Bình Định": "Gia Lai",
        "Hà Nội": "Hà Nội", "VN-HN": "Hà Nội",
        "Hà Tĩnh": "Hà Tĩnh", "VN-23": "Hà Tĩnh",
        "Hưng Yên": "Hưng Yên", "VN-66": "Hưng Yên", "VN-20": "Hưng Yên", "Thái Bình": "Hưng Yên",
        "Hải Phòng": "Hải Phòng", "VN-61": "Hải Phòng", "VN-HP": "Hải Phòng", "Hải Dương": "Hải Phòng",
        "Hồ Chí Minh": "Hồ Chí Minh", "VN-43": "Hồ Chí Minh", "VN-57": "Hồ Chí Minh", "VN-SG": "Hồ Chí Minh", "Bình Dương": "Hồ Chí Minh", "Bà Rịa - Vũng Tàu": "Hồ Chí Minh",
        "Khánh Hòa": "Khánh Hòa", "VN-34": "Khánh Hòa", "VN-36": "Khánh Hòa", "Ninh Thuận": "Khánh Hòa",
        "Lai Châu": "Lai Châu", "VN-01": "Lai Châu",
        "Lào Cai": "Lào Cai", "VN-02": "Lào Cai", "VN-06": "Lào Cai", "Yên Bái": "Lào Cai",
        "Lâm Đồng": "Lâm Đồng", "VN-40": "Lâm Đồng", "VN-35": "Lâm Đồng", "VN-72": "Lâm Đồng", "Đắk Nông": "Lâm Đồng", "Bình Thuận": "Lâm Đồng",
        "Lạng Sơn": "Lạng Sơn", "VN-09": "Lạng Sơn",
        "Nghệ An": "Nghệ An", "VN-22": "Nghệ An",
        "Ninh Bình": "Ninh Bình", "VN-63": "Ninh Bình", "VN-67": "Ninh Bình", "VN-18": "Ninh Bình", "Hà Nam": "Ninh Bình", "Nam Định": "Ninh Bình",
        "Phú Thọ": "Phú Thọ", "VN-14": "Phú Thọ", "VN-68": "Phú Thọ", "VN-70": "Phú Thọ", "Vĩnh Phúc": "Phú Thọ", "Hòa Bình": "Phú Thọ",
        "Quảng Ngãi": "Quảng Ngãi", "VN-28": "Quảng Ngãi", "VN-29": "Quảng Ngãi", "Kon Tum": "Quảng Ngãi",
        "Quảng Ninh": "Quảng Ninh", "VN-13": "Quảng Ninh",
        "Quảng Trị": "Quảng Trị", "VN-24": "Quảng Trị", "VN-25": "Quảng Trị", "Quảng Bình": "Quảng Trị",
        "Sơn La": "Sơn La", "VN-05": "Sơn La",
        "Thanh Hóa": "Thanh Hóa", "VN-21": "Thanh Hóa",
        "Thành phố Cần Thơ": "Thành phố Cần Thơ", "Cần Thơ": "Thành phố Cần Thơ", "VN-CT": "Thành phố Cần Thơ", "VN-73": "Thành phố Cần Thơ", "VN-52": "Thành phố Cần Thơ", "Hậu Giang": "Thành phố Cần Thơ", "Sóc Trăng": "Thành phố Cần Thơ",
        "Thái Nguyên": "Thái Nguyên", "VN-53": "Thái Nguyên", "VN-69": "Thái Nguyên", "Bắc Kạn": "Thái Nguyên",
        "Thừa Thiên-Huế": "Thừa Thiên-Huế", "Huế": "Thừa Thiên-Huế", "VN-26": "Thừa Thiên-Huế",
        "Tuyên Quang": "Tuyên Quang", "VN-03": "Tuyên Quang", "VN-07": "Tuyên Quang", "Hà Giang": "Tuyên Quang",
        "Tây Ninh": "Tây Ninh", "VN-41": "Tây Ninh", "VN-37": "Tây Ninh", "Long An": "Tây Ninh",
        "Vĩnh Long": "Vĩnh Long", "VN-50": "Vĩnh Long", "VN-51": "Vĩnh Long", "VN-49": "Vĩnh Long", "Bến Tre": "Vĩnh Long", "Trà Vinh": "Vĩnh Long",
        "Điện Biên": "Điện Biên", "VN-71": "Điện Biên",
        "Đà Nẵng": "Đà Nẵng", "VN-27": "Đà Nẵng", "VN-DN": "Đà Nẵng", "Quảng Nam": "Đà Nẵng",
        "Đắk Lắk": "Đắk Lắk", "VN-32": "Đắk Lắk", "VN-33": "Đắk Lắk", "Phú Yên": "Đắk Lắk",
        "Đồng Nai": "Đồng Nai", "VN-58": "Đồng Nai", "VN-39": "Đồng Nai", "Bình Phước": "Đồng Nai",
        "Đồng Tháp": "Đồng Tháp", "VN-46": "Đồng Tháp", "VN-45": "Đồng Tháp", "Tiền Giang": "Đồng Tháp"
    };

    // Hàm ánh xạ tên/id cũ sang tên mới
    $scope.getNewProvinceName = function(oldNameOrId) {
        return $scope.provinceOldToNew[oldNameOrId] || oldNameOrId;
    };

    // Import mapping mới nếu cần, hoặc copy lại logic ánh xạ mã ISO cũ sang tên mới
    $scope.getNewProvinceNameFromISO = function(oldIso) {
        // Mapping này nên đồng bộ với backend
        const isoToNewProvince = {
            "VN-44": "An Giang", "VN-47": "An Giang",
            "VN-54": "Bắc Ninh", "VN-56": "Bắc Ninh",
            "VN-04": "Cao Bằng",
            "VN-55": "Cà Mau", "VN-59": "Cà Mau",
            "VN-31": "Gia Lai", "VN-30": "Gia Lai",
            "VN-HN": "Hà Nội",
            "VN-23": "Hà Tĩnh",
            "VN-66": "Hưng Yên", "VN-20": "Hưng Yên",
            "VN-61": "Hải Phòng", "VN-HP": "Hải Phòng",
            "VN-43": "Hồ Chí Minh", "VN-57": "Hồ Chí Minh", "VN-SG": "Hồ Chí Minh",
            "VN-34": "Khánh Hòa", "VN-36": "Khánh Hòa",
            "VN-01": "Lai Châu",
            "VN-02": "Lào Cai", "VN-06": "Lào Cai",
            "VN-40": "Lâm Đồng", "VN-35": "Lâm Đồng", "VN-72": "Lâm Đồng",
            "VN-09": "Lạng Sơn",
            "VN-22": "Nghệ An",
            "VN-63": "Ninh Bình", "VN-67": "Ninh Bình", "VN-18": "Ninh Bình",
            "VN-14": "Phú Thọ", "VN-68": "Phú Thọ", "VN-70": "Phú Thọ",
            "VN-28": "Quảng Ngãi", "VN-29": "Quảng Ngãi",
            "VN-13": "Quảng Ninh",
            "VN-24": "Quảng Trị", "VN-25": "Quảng Trị",
            "VN-05": "Sơn La",
            "VN-21": "Thanh Hóa",
            "VN-CT": "Thành phố Cần Thơ", "VN-73": "Thành phố Cần Thơ", "VN-52": "Thành phố Cần Thơ",
            "VN-53": "Thái Nguyên", "VN-69": "Thái Nguyên",
            "VN-26": "Thừa Thiên-Huế",
            "VN-03": "Tuyên Quang", "VN-07": "Tuyên Quang",
            "VN-41": "Tây Ninh", "VN-37": "Tây Ninh",
            "VN-50": "Vĩnh Long", "VN-51": "Vĩnh Long", "VN-49": "Vĩnh Long",
            "VN-71": "Điện Biên",
            "VN-27": "Đà Nẵng", "VN-DN": "Đà Nẵng",
            "VN-32": "Đắk Lắk", "VN-33": "Đắk Lắk",
            "VN-58": "Đồng Nai", "VN-39": "Đồng Nai",
            "VN-46": "Đồng Tháp", "VN-45": "Đồng Tháp"
        };
    ...
    $scope.handleManualUpdate = function(event) {
        ...
        if ($scope.distributionInputText && typeof $scope.distributionInputText === 'string') {
            ...
            provinceNames.forEach(name => {
                const newName = $scope.getNewProvinceName(name);
                if (newName) {
                    distributionNames.push(newName);
                } else {
        ...
        $scope.species.distribution = Array.from(new Set(distributionNames));

        // Cảnh báo nếu có tên tỉnh không tìm thấy
        if (notFoundNames.length > 0) {
            alert("Không tìm thấy tên mới cho các tỉnh/thành sau: " + notFoundNames.join(', ') + ". Các tỉnh này sẽ không được lưu.");
            console.warn("Không tìm thấy tên mới cho các tỉnh/thành:", notFoundNames);
        }
